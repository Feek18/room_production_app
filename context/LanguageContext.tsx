...
const translations = {
  id: {
    ...
    "core.step.2.title": "Design Visual",
    "core.step.2.desc": "Design mockup visual untuk detail ukuran, sablon dan bordir sebelum proses produksi.",
    "core.step.3.title": "Proses produksi",
    "core.step.3.desc": "Proses pemotongan bahan, penjahitan, sablon/bordir berkualitas premium dengan QC dan waktu produksi yang presisi.",
    "core.step.4.title": "Pengiriman",
    "core.step.4.desc": "Menerima pengiriman ke seluruh area di Indonesia.",
    ...
    "why.6.title": "Garansi Produk",
    "why.6.desc": "Kami memberikan garansi produk jika produk yang Anda terima tidak sesuai dengan pesanan anda.",
    ...
    "map.addr.content": "Jalan Tukad Batanghari VII, Dauh Puri Klod, Kota Denpasar, Bali",
  ...
  en: {
    ...
    "core.step.2.title": "Visual Design",
    "core.step.2.desc": "Visual mockup design for size details, printing and embroidery before production.",
    "core.step.3.title": "Production Process",
    "core.step.3.desc": "Fabric cutting, sewing, premium quality printing/embroidery with precise QC and production time.",
    "core.step.4.title": "Delivery",
    "core.step.4.desc": "We ship to all areas in Indonesia.",
    ...
    "why.6.title": "Product Warranty",
    "why.6.desc": "We provide a product warranty if the product you receive does not match your order.",
    ...
    "map.addr.content": "Jalan Tukad Batanghari VII, Dauh Puri Klod, Denpasar City, Bali",
